...
Description:
			This function creates a new charachter to display
			Args: 8 elements array to represent char, address of the character as the charavter will be displayed using this address
*/
