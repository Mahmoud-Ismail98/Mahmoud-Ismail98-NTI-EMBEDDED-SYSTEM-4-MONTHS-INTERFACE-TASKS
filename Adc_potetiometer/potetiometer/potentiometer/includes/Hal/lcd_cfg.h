...
#define LCD_RS_PORT_ID                 LCD_PORTC
#define LCD_RS_PIN_ID                  PORT_PIN16_ID

#define LCD_E_PORT_ID                  LCD_PORTC
#define LCD_E_PIN_ID                   PORT_PIN17_ID

/* 8_bit mode port */
#define LCD_DATA_PORT_ID               LCD_PORTB
