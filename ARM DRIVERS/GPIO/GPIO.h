...
//STRUCT MODE OPTIONS
#define GPIO_MODE_u64_INPUT       							1

#define GPIO_MODE_u64_OUTPUT_PP								2

#define GPIO_MODE_u64_OUTPUT_OD								3

#define GPIO_MODE_u64_AF_PP									4

#define GPIO_MODE_u64_AF_OD									5

#define GPIO_MODE_u64_ANALOG							    6
...
Gpio_tenuErrorStatus Gpio_initAll();
