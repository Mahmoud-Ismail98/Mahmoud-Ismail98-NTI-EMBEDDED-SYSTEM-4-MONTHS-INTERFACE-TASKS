...
void LCD_voidInit(void)
{
	...
	DIO_WritrPin(PIN_ID3,LOW_LEVEL);
/*
...
void LCD_voidWriteCharacter(u8 Character)
{
	...
	DIO_WritrPin(D0_PIN,GET_BIT(Character,PIN_ID0));
	DIO_WritrPin(D1_PIN,GET_BIT(Character,PIN_ID1));
	DIO_WritrPin(D2_PIN,GET_BIT(Character,PIN_ID2));
	DIO_WritrPin(D3_PIN,GET_BIT(Character,PIN_ID3));
	DIO_WritrPin(D4_PIN,GET_BIT(Character,PIN_ID4));
	DIO_WritrPin(D5_PIN,GET_BIT(Character,PIN_ID5));
	DIO_WritrPin(D6_PIN,GET_BIT(Character,PIN_ID6));
	DIO_WritrPin(D7_PIN,GET_BIT(Character,PIN_ID7));
...
void LCD_voidSendCommand(u8 Command)
{
	...
	DIO_WritrPin(D0_PIN,GET_BIT(Command,PIN_ID0));
	DIO_WritrPin(D1_PIN,GET_BIT(Command,PIN_ID1));
	DIO_WritrPin(D2_PIN,GET_BIT(Command,PIN_ID2));
	DIO_WritrPin(D3_PIN,GET_BIT(Command,PIN_ID3));
	DIO_WritrPin(D4_PIN,GET_BIT(Command,PIN_ID4));
	DIO_WritrPin(D5_PIN,GET_BIT(Command,PIN_ID5));
	DIO_WritrPin(D6_PIN,GET_BIT(Command,PIN_ID6));
	DIO_WritrPin(D7_PIN,GET_BIT(Command,PIN_ID7));
