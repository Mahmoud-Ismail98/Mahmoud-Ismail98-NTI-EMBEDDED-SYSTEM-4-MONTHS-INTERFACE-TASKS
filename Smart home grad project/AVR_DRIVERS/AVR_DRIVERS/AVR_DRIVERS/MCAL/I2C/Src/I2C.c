...
I2C_ERROR_ST I2C_SEND_Adress_WRITE(u8 address)
{
	TWDR=address<<1;
	I2C_START_ACTION();
	_delay_ms(10);
}
I2C_ERROR_ST I2C_SEND_Adress_READ(u8 address)
{
	I2C_ENABLE_ACK();
	TWDR=((address<<1)|0x01);
	I2C_START_ACTION();
...
I2C_ERROR_ST I2C_SEND_FULL_FRAME_WRITE(u8 aderss,u8 data)
{
	I2C_SendStart();
	I2C_START_ACTION();
	//I2C_SEND_Adress_WRITE();
	I2C_SEND_DATA(data);
}
