...
#define PORT_u8_PB4_DIRECTION             PORT_u8_INITIAL_INPUT
#define PORT_u8_PB5_DIRECTION             PORT_u8_INITIAL_INPUT
#define PORT_u8_PB6_DIRECTION             PORT_u8_INITIAL_OUTPUT
#define PORT_u8_PB7_DIRECTION             PORT_u8_INITIAL_INPUT
// PORTC 
...
#define PORT_u8_PB4_VALUE             PORT_u8_INPUT_PULLUP
#define PORT_u8_PB5_VALUE             PORT_u8_INPUT_PULLUP
#define PORT_u8_PB6_VALUE             PORT_u8_OUTPUT_LOW
#define PORT_u8_PB7_VALUE             PORT_u8_INPUT_PULLUP
// PORTC                              
