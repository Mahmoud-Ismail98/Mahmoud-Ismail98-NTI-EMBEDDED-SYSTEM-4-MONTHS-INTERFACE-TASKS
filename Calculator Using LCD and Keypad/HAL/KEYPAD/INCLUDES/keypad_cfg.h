...
#define KEYPAD_ROW0_COL3_SYMPOL                            '/' /* Not used in 3-columns size. */
#define KEYPAD_ROW1_COL0_SYMPOL                            '4'
#define KEYPAD_ROW1_COL1_SYMPOL                            '5'
#define KEYPAD_ROW1_COL2_SYMPOL                            '6'
#define KEYPAD_ROW1_COL3_SYMPOL                            '*' /* Not used in 3-columns size. */
#define KEYPAD_ROW2_COL0_SYMPOL                            '1'
#define KEYPAD_ROW2_COL1_SYMPOL                            '2'
#define KEYPAD_ROW2_COL2_SYMPOL                            '3'
#define KEYPAD_ROW2_COL3_SYMPOL                            '-' /* Not used in 3-columns size. */
#define KEYPAD_ROW3_COL0_SYMPOL                            'C'
#define KEYPAD_ROW3_COL1_SYMPOL                            '0'
#define KEYPAD_ROW3_COL2_SYMPOL                            '='
#define KEYPAD_ROW3_COL3_SYMPOL                            '+' /* Not used in 3-columns size. */
