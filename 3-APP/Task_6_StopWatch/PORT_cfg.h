...
#define PORT_A_PIN_2_CFG                    PORT_MODE_OUTPUT_HIGH
#define PORT_A_PIN_3_CFG                    PORT_MODE_OUTPUT_HIGH
...
#define PORT_B_PIN_0_CFG                    PORT_MODE_OUTPUT_HIGH
#define PORT_B_PIN_1_CFG                    PORT_MODE_OUTPUT_HIGH
#define PORT_B_PIN_2_CFG                    PORT_MODE_OUTPUT_HIGH
#define PORT_B_PIN_3_CFG                    PORT_MODE_INPUT_FLOATING
#define PORT_B_PIN_4_CFG                    PORT_MODE_OUTPUT_HIGH
#define PORT_B_PIN_5_CFG                    PORT_MODE_OUTPUT_HIGH
#define PORT_B_PIN_6_CFG                    PORT_MODE_OUTPUT_HIGH
...
#define PORT_C_PIN_2_CFG                    PORT_MODE_INPUT_PULLUP
#define PORT_C_PIN_3_CFG                    PORT_MODE_INPUT_PULLUP
#define PORT_C_PIN_4_CFG                    PORT_MODE_INPUT_PULLUP
...
#define PORT_D_PIN_7_CFG                    PORT_MODE_OUTPUT_LOW
