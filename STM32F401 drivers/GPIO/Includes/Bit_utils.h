...
//////////////////////////////////////////////////
#define CONCC(B1,B0)			    CONCC_HELPER(B1,B0)
#define CONCC_HELPER(B1,B0)		B1##B0
//////////////////////////////////////////////////
#define CONCA(B15,B14,B13,B12,B11,B10,B9,B8,B7,B6,B5,B4,B3,B2,B1,B0)			     CONCA_HELPER(B15,B14,B13,B12,B11,B10,B9,B8,B7,B6,B5,B4,B3,B2,B1,B0)
#define CONCA_HELPER(B15,B14,B13,B12,B11,B10,B9,B8,B7,B6,B5,B4,B3,B2,B1,B0)		 0b##B15##B14##B13##B12##B11##B10##B9##B8##B7##B6##B5##B4##B3##B2##B1##B0
