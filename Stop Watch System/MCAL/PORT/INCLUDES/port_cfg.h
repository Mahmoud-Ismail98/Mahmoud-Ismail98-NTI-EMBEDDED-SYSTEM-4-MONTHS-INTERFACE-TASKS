...
#define PORT_PORTD_PIN4_PIN_MODE                    PORT_INPUT_FLOAT_PIN
#define PORT_PORTD_PIN5_PIN_MODE                    PORT_INPUT_FLOAT_PIN
#define PORT_PORTD_PIN6_PIN_MODE                    PORT_INPUT_FLOAT_PIN
